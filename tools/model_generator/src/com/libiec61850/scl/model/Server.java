...
public class Server {
	...
	public Server(Node serverNode, TypeDeclarations typeDeclarations, IED ied) throws SclParserException {
		...
		for (Node ldNode : ldNodes) {
			logicalDevices.add(new LogicalDevice(ldNode, typeDeclarations, ied));
		}
